...
class Config:
    ...
    def from_env(cls) -> "Config":
        return cls(
            ...
            fingerprint_cooldown_seconds=parse_int("LOG_WATCHER_FINGERPRINT_COOLDOWN_SECONDS", 3600),
            global_window_seconds=parse_int("LOG_WATCHER_GLOBAL_WINDOW_SECONDS", 900),
            global_max_notifications=parse_int("LOG_WATCHER_GLOBAL_MAX_NOTIFICATIONS", 3),
            ...
            mute_minutes=parse_int("LOG_WATCHER_MUTE_MINUTES", 60),
